...
var author$project$Main$textCell = F2(
	function (raw, isActive) {
		return {
			content: author$project$Main$Text,
			cursorPosition: {column: 1, line: 1},
			isActive: isActive,
			lines: A2(elm$core$String$split, '\n', raw),
			raw: raw
		};
	});
	...
	return _Utils_Tuple2(
		{
			cells: A2(
				elm$core$Array$push,
				A2(author$project$Main$textCell, '# Title\n', true),
...
var author$project$Main$Unsupported = {$: 'Unsupported'};
var author$project$Main$toKey = function (keyCode) {
	switch (keyCode) {
		case 'Escape':
			return author$project$Main$Escape;
		case 'ArrowDown':
		...
		default:
			return author$project$Main$Unsupported;
	}
};
...
var author$project$Main$CellFocusErr = function (a) {
	return {$: 'CellFocusErr', a: a};
};
var author$project$Main$CellFocusOk = function (a) {
	return {$: 'CellFocusOk', a: a};
};
...
var author$project$Main$findActiveCell = function () {
	var isActive = function (_n0) {
		var cell = _n0.b;
		return cell.isActive;
	};
	return A2(
		elm$core$Basics$composeL,
		elm_community$list_extra$List$Extra$find(isActive),
		elm$core$Array$toIndexedList);
}();
var elm$core$String$foldl = _String_foldl;
var author$project$Main$getCursorPosition = function (cell) {
	var worker = F2(
		function (_char, curr) {
			if ('\n' === _char.valueOf()) {
	...
	var _default = {column: 1, line: 1};
	return A3(elm$core$String$foldl, worker, _default, cell.raw);
};
var author$project$Main$updateColumn = F2(
	function (inc, srcLoc) {
		return ((srcLoc.column + inc) < 0) ? srcLoc : _Utils_update(
			srcLoc,
			{column: srcLoc.column + inc});
	});
var author$project$Main$updateLine = F2(
	function (inc, srcLoc) {
		return ((srcLoc.line + inc) < 0) ? srcLoc : _Utils_update(
			srcLoc,
			{line: srcLoc.line + inc});
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				switch (key.$) {
					...
					case 'Escape':
						return _Utils_Tuple2(
							...
							elm$core$Platform$Cmd$none);
					case 'ArrowDown':
						var _n2 = author$project$Main$findActiveCell(model.cells);
						if (_n2.$ === 'Just') {
							var _n3 = _n2.a;
							var index = _n3.a;
							var cell = _n3.b;
							var updated = _Utils_update(
								cell,
								{
									cursorPosition: A2(author$project$Main$updateLine, 1, cell.cursorPosition)
								});
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										cells: A3(elm$core$Array$set, index, updated, model.cells)
									}),
								elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					...
					case 'ArrowLeft':
						var _n4 = author$project$Main$findActiveCell(model.cells);
						if (_n4.$ === 'Just') {
							var _n5 = _n4.a;
							var index = _n5.a;
							var cell = _n5.b;
							var updated = _Utils_update(
								cell,
								{
									cursorPosition: A2(author$project$Main$updateColumn, -1, cell.cursorPosition)
								});
							return _Utils_Tuple2(
								_Utils_update(
									model,
					...
					case 'ArrowRight':
						var _n6 = author$project$Main$findActiveCell(model.cells);
						if (_n6.$ === 'Just') {
							var _n7 = _n6.a;
							var index = _n7.a;
							var cell = _n7.b;
					...
					default:
						var _n8 = author$project$Main$findActiveCell(model.cells);
						if (_n8.$ === 'Just') {
							var _n9 = _n8.a;
							var index = _n9.a;
							var cell = _n9.b;
			...
			case 'CellActive':
				var index = msg.a;
				var toFocusMsg = function (result) {
					if (result.$ === 'Ok') {
						return author$project$Main$CellFocusOk(index);
					} else {
						return author$project$Main$CellFocusErr(index);
					}
				};
				var focusTask = elm$browser$Browser$Dom$focus(
					'cell-input-' + elm$core$String$fromInt(index));
				var _n10 = A2(elm$core$Array$get, index, model.cells);
				if (_n10.$ === 'Just') {
					var cell = _n10.a;
					var updated = _Utils_update(
						cell,
					...
					return _Utils_Tuple2(
						...
						A2(elm$core$Task$attempt, toFocusMsg, focusTask));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				var index = msg.a;
				var raw = msg.b;
				var _n12 = A2(elm$core$Array$get, index, model.cells);
				if (_n12.$ === 'Just') {
					var cell = _n12.a;
					var updatedLines = A2(elm$core$String$split, '\n', raw);
					var updated = _Utils_update(
						cell,
						{
							cursorPosition: author$project$Main$getCursorPosition(cell),
							lines: updatedLines,
							raw: raw
						});
					return _Utils_Tuple2(
...
var author$project$Main$CellActive = function (a) {
	return {$: 'CellActive', a: a};
};
var author$project$Main$CellUpdated = F2(
	function (a, b) {
		return {$: 'CellUpdated', a: a, b: b};
	});
...
var author$project$Main$textCellView = function (_n0) {
	var index = _n0.a;
	var cell = _n0.b;
	return A2(
		elm$html$Html$div,
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('editor-active', cell.isActive)
					])),
				elm$html$Html$Events$onClick(
				author$project$Main$CellActive(index))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('editor-input', true)
							])),
						elm$html$Html$Attributes$id(
						'cell-input-' + elm$core$String$fromInt(index)),
						elm$html$Html$Events$onInput(
						author$project$Main$CellUpdated(index))
					]),
				_List_fromArray(
					[
						elm$html$Html$text(cell.raw)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('editor-display', true)
							]))
					]),
				_List_fromArray(
					[
						A2(elm_explorations$markdown$Markdown$toHtml, _List_Nil, cell.raw)
					]))
			]));
};
var author$project$Main$cellView = function (_n0) {
	var index = _n0.a;
	var cell = _n0.b;
	var _n1 = cell.content;
	if (_n1.$ === 'Code') {
		return A2(elm$html$Html$textarea, _List_Nil, _List_Nil);
	} else {
		return author$project$Main$textCellView(
			_Utils_Tuple2(index, cell));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('document', true)
					]))
			]),
		A2(
			elm$core$List$map,
			author$project$Main$cellView,
			elm$core$Array$toIndexedList(model.cells)));
};
var elm$browser$Browser$element = _Browser_element;
var author$project$Main$main = elm$browser$Browser$element(
	{init: author$project$Main$init, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Main$view});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"CellUpdated":["Basics.Int","String.String"],"CellActive":["Basics.Int"],"KeyPressed":["Main.Key"],"CellFocusOk":["Basics.Int"],"CellFocusErr":["Basics.Int"]}},"Main.Key":{"args":[],"tags":{"Escape":[],"Unsupported":[],"ArrowDown":[],"ArrowLeft":[],"ArrowRight":[],"ArrowUp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));