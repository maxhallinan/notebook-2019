...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["ExprAnn"] = $PS["ExprAnn"] || {};
  var exports = $PS["ExprAnn"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_List_Types = $PS["Data.List.Types"];
  var Data_Monoid = $PS["Data.Monoid"];
  ...
  var SymTipe = (function () {
      function SymTipe() {

      };
      SymTipe.value = new SymTipe();
      return SymTipe;
  })();
  var LstTipe = (function () {
      function LstTipe() {

      };
      LstTipe.value = new LstTipe();
      return LstTipe;
  })();
  var FnTipe = (function () {
      function FnTipe() {
      ...
      FnTipe.value = new FnTipe();
      return FnTipe;
  })();
  var SFrmTipe = (function () {
      function SFrmTipe() {

      };
      SFrmTipe.value = new SFrmTipe();
      return SFrmTipe;
  })();
  var ExprAnn = (function () {
      function ExprAnn(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ExprAnn.create = function (value0) {
          return function (value1) {
              return new ExprAnn(value0, value1);
          };
      };
      return ExprAnn;
  })();
  var Sym = (function () {
      ...
      Sym.create = function (value0) {
          return new Sym(value0);
      };
      return Sym;
  })();
  var SFrm = (function () {
      function SFrm(value0) {
          this.value0 = value0;
      };
      SFrm.create = function (value0) {
          return new SFrm(value0);
      };
      return SFrm;
  })();
  var Fn = (function () {
      function Fn(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Fn.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Fn(value0, value1, value2);
              };
          };
      };
      return Fn;
  ...
  var Lst = (function () {
      ...
      Lst.create = function (value0) {
          return new Lst(value0);
      };
      return Lst;
  })();
  var toExprTipe = function (v) {
      if (v.value0 instanceof Sym) {
          return SymTipe.value;
      };
      if (v.value0 instanceof Lst) {
          return LstTipe.value;
      };
      if (v.value0 instanceof Fn) {
          return FnTipe.value;
      };
      if (v.value0 instanceof SFrm) {
          return SFrmTipe.value;
      };
      throw new Error("Failed pattern match at ExprAnn (line 87, column 3 - line 95, column 15): " + [ v.value0.constructor.name ]);
  };
  var showSFrm = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at ExprAnn (line 57, column 1 - line 66, column 23): " + [ v.constructor.name ]);
  });
  var showExprAnn = new Data_Show.Show(function (v) {
      return Data_Show.show(showExpr)(v.value0);
  });
  var showExpr = new Data_Show.Show(function (v) {
      if (v instanceof Sym) {
          return v.value0;
      };
      if (v instanceof SFrm) {
          return Data_Show.show(showSFrm)(v.value0);
      };
      if (v instanceof Fn) {
          return "<function>";
      };
      if (v instanceof Lst) {
          var exprs$prime = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)(" ")(Data_Functor.map(Data_List_Types.functorList)(Data_Show.show(showExprAnn))(v.value0));
          return "(" + (exprs$prime + ")");
      };
      throw new Error("Failed pattern match at ExprAnn (line 36, column 1 - line 41, column 52): " + [ v.constructor.name ]);
  });
  var sfrmNumArgs = function (v) {
      if (v instanceof Cons) {
          return 2;
      };
      if (v instanceof Def) {
      ...
      throw new Error("Failed pattern match at ExprAnn (line 68, column 1 - line 68, column 27): " + [ v.constructor.name ]);
  };
  exports["Sym"] = Sym;
  exports["SFrm"] = SFrm;
  exports["Fn"] = Fn;
  exports["Lst"] = Lst;
  exports["ExprAnn"] = ExprAnn;
  exports["SymTipe"] = SymTipe;
  exports["LstTipe"] = LstTipe;
  exports["FnTipe"] = FnTipe;
  exports["SFrmTipe"] = SFrmTipe;
  exports["First"] = First;
  exports["Rest"] = Rest;
  exports["Cons"] = Cons;
  exports["If"] = If;
  ...
  exports["Quote"] = Quote;
  exports["sfrmNumArgs"] = sfrmNumArgs;
  exports["toExprTipe"] = toExprTipe;
  exports["showExprAnn"] = showExprAnn;
  exports["showExpr"] = showExpr;
  exports["showSFrm"] = showSFrm;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  ...
  var Data_Traversable = $PS["Data.Traversable"];
  var Data_Tuple = $PS["Data.Tuple"];
  var ExprAnn = $PS["ExprAnn"];                
  var EvalState = function (x) {
      return x;
  };
  var NumArgs = (function () {
      function NumArgs(value0) {
          this.value0 = value0;
      };
      NumArgs.create = function (value0) {
          return new NumArgs(value0);
      };
      return NumArgs;
  })();
  var WrongTipe = (function () {
      function WrongTipe(value0) {
          this.value0 = value0;
      };
      WrongTipe.create = function (value0) {
          return new WrongTipe(value0);
      };
      return WrongTipe;
  })();
  var LstLength = (function () {
      function LstLength(value0) {
          this.value0 = value0;
      };
      LstLength.create = function (value0) {
          return new LstLength(value0);
      };
      return LstLength;
  })();
  var UnknownVar = (function () {
      function UnknownVar(value0) {
          this.value0 = value0;
      };
      UnknownVar.create = function (value0) {
          return new UnknownVar(value0);
      };
      return UnknownVar;
  })();
  var EmptyFnApplication = (function () {
      function EmptyFnApplication() {

      };
      EmptyFnApplication.value = new EmptyFnApplication();
      return EmptyFnApplication;
  })();
  var UnknownErr = (function () {
      function UnknownErr() {

      };
      UnknownErr.value = new UnknownErr();
      return UnknownErr;
  })();
  var EvalErr = (function () {
      function EvalErr(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      EvalErr.create = function (value0) {
          return function (value1) {
              return new EvalErr(value0, value1);
          };
      };
      return EvalErr;
  })();
  var EvalT = function (x) {
      return x;
  };
  var wrongTipeErr = function (expected) {
      return function (received) {
          return new WrongTipe({
              expected: expected,
              received: received
          });
      };
  };
  var unknownVarErr = function (varName) {
      return new UnknownVar({
          varName: varName
      });
  };
  var unknownErr = UnknownErr.value;
  var showEvalErr = new Data_Show.Show(function (v) {
      if (v.value0 instanceof NumArgs) {
          return "wrong number of arguments";
      };
      if (v.value0 instanceof WrongTipe) {
          return "wrong type";
      };
      if (v.value0 instanceof LstLength) {
          return "wrong list length";
      };
      if (v.value0 instanceof UnknownVar) {
          return "unknown identifier " + v.value0.value0.varName;
      };
      if (v.value0 instanceof EmptyFnApplication) {
          return "empty list in function application position";
      };
      if (v.value0 instanceof UnknownErr) {
          return "unknown error";
      };
      throw new Error("Failed pattern match at Eval (line 139, column 5 - line 151, column 24): " + [ v.value0.constructor.name ]);
  });
  var resultWithEnv = function (v) {
      return {
          env: v.value1.env,
          result: v.value0
      };
  };
  var numArgsErr = function (expected) {
      return function (received) {
          return new NumArgs({
              expected: expected,
              received: received
  ...
  var newtypeEvalT = new Data_Newtype.Newtype(function (n) {
      return n;
  }, EvalT);
  var run = function (env) {
      return function (evaled) {
          var rn = (function () {
              var $224 = Data_Newtype.unwrap(newtypeEvalT);
              return function ($225) {
                  return Control_Monad_State_Trans.runStateT(Control_Monad_Except_Trans.runExceptT($224($225)));
              };
          })();
          var evalState = {
              env: env
          };
          return Data_Functor.map(Data_Identity.functorIdentity)(resultWithEnv)(rn(evaled)(evalState));
      };
  };
  ...
  var $$throw = function (dictMonad) {
      return function (ann) {
          return function (name) {
              return Control_Monad_Error_Class.throwError(monadThrowParserT(dictMonad))(new EvalErr(name, ann.srcSpan));
          };
      };
  };
  var throwNumArgsErr = function (dictMonad) {
      return function (ann) {
          return function (expected) {
              return function (received) {
                  return $$throw(dictMonad)(ann)(numArgsErr(expected)(received));
              };
          };
      };
  };
  var throwSFrmNumArgsErr = function (dictMonad) {
      return function (ann) {
          return function (sfrm) {
              return function (args) {
                  var received = Data_Foldable.length(Data_List_Types.foldableList)(Data_Semiring.semiringInt)(args);
                  var expected = ExprAnn.sfrmNumArgs(sfrm);
                  return throwNumArgsErr(dictMonad)(ann)(expected)(received);
              };
          };
      };
  };
  var throwUnknownErr = function (dictMonad) {
      return function (ann) {
          return $$throw(dictMonad)(ann)(unknownErr);
      };
  };
  var throwUnknownVarErr = function (dictMonad) {
      return function (ann) {
          return function (varName) {
              return $$throw(dictMonad)(ann)(unknownVarErr(varName));
          };
      };
  };
  var throwWrongTipeErr = function (dictMonad) {
      return function (ann) {
          return function (expected) {
              return function (received) {
                  return $$throw(dictMonad)(ann)(wrongTipeErr(expected)(received));
              };
          };
      };
  };
  ...
  var lstLengthErr = function (expected) {
      return function (received) {
          return new LstLength({
              expected: expected,
              received: received
          });
      };
  };
  var throwLstLengthErr = function (dictMonad) {
      return function (ann) {
          return function (expected) {
              return function (received) {
                  return $$throw(dictMonad)(ann)(lstLengthErr(expected)(received));
              };
          };
      };
  };
  var functorEvalT = function (dictFunctor) {
      return Control_Monad_Except_Trans.functorExceptT(Control_Monad_State_Trans.functorStateT(dictFunctor));
  };
  var evalStateNewtype = new Data_Newtype.Newtype(function (n) {
      return n;
  }, EvalState);
  var emptyFnApplicationErr = EmptyFnApplication.value;
  var throwEmptyFnApplicationErr = function (dictMonad) {
      return function (ann) {
          return $$throw(dictMonad)(ann)(emptyFnApplicationErr);
      };
  };
  var bindEvalT = function (dictMonad) {
      return Control_Monad_Except_Trans.bindExceptT(Control_Monad_State_Trans.monadStateT(dictMonad));
  };
  var updateEnv = function (dictMonad) {
      return function (key) {
          return function (val) {
              return Control_Bind.bind(bindEvalT(dictMonad))(Data_Functor.map(functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0()))(Data_Newtype.unwrap(evalStateNewtype))(Control_Monad_State_Class.get(monadStateParserT(dictMonad))))(function (v) {
                  return Control_Monad_State_Class.put(monadStateParserT(dictMonad))({
                      env: Data_Map_Internal.insert(Data_Ord.ordString)(key)(val)(v.env)
                  });
              });
          };
      };
  };
  var applicativeEvalT = function (dictMonad) {
      return Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_State_Trans.monadStateT(dictMonad));
  };
  var evalQuote = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
              return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(v.value0);
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.Quote.value)(v);
      };
  };
  var getEnv = function (dictMonad) {
      return Control_Bind.bind(bindEvalT(dictMonad))(Control_Monad_State_Class.get(monadStateParserT(dictMonad)))((function () {
          var $226 = Control_Applicative.pure(applicativeEvalT(dictMonad));
          var $227 = Data_Newtype.unwrap(evalStateNewtype);
          return function ($228) {
              return $226((function (v) {
                  return v.env;
              })($227($228)));
          };
      })());
  };
  var bindArgs = function (ann) {
      return function (params) {
          return function (args) {
              var toParamName = function (v) {
                  if (v.value0 instanceof ExprAnn.Sym) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(v.value0.value0);
                  };
                  return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.SymTipe.value)(ExprAnn.toExprTipe(v));
              };
              var toBinding = function (param) {
                  return function (arg) {
                      return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(toParamName(param))(function (v) {
                          return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new Data_Tuple.Tuple(v, arg));
                      });
                  };
              };
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(getEnv(Data_Identity.monadIdentity))(function (v) {
                  return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(Data_Traversable.sequence(Data_List_Types.traversableList)(applicativeEvalT(Data_Identity.monadIdentity))(Data_List.zipWith(toBinding)(params)(args)))(function (v1) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_List_Types.foldableList)(v1))(v));
                  });
              });
          };
      };
  };
  var evalLambda = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
              if (v.value0.value0 instanceof ExprAnn.Lst) {
                  return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(getEnv(Data_Identity.monadIdentity))(function (v1) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Fn(v1, v.value0.value0.value0, v.value1.value0), ann));
                  });
              };
              return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.LstTipe.value)(ExprAnn.toExprTipe(v.value0));
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.Lambda.value)(v);
      };
  };
  var evalSym = function (ann) {
      return function (name) {
          return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(getEnv(Data_Identity.monadIdentity))(function (v) {
              var v1 = Data_Map_Internal.lookup(Data_Ord.ordString)(name)(v);
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(v1.value0);
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return throwUnknownVarErr(Data_Identity.monadIdentity)(ann)(name);
              };
              throw new Error("Failed pattern match at Eval (line 205, column 3 - line 209, column 34): " + [ v1.constructor.name ]);
          });
      };
  };
  var evalSFrm = function (ann) {
      return function (v) {
          return function (v1) {
              if (v1 instanceof Data_List_Types.Nil) {
                  return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(v)(Data_List_Types.Nil.value);
              };
              if (v instanceof ExprAnn.Cons) {
                  return evalCons(ann)(v1);
              };
              if (v instanceof ExprAnn.Def) {
                  return evalDef(ann)(v1);
              };
              if (v instanceof ExprAnn.First) {
                  return evalFirst(ann)(v1);
              };
              if (v instanceof ExprAnn.If) {
                  return evalIf(ann)(v1);
              };
              if (v instanceof ExprAnn.IsAtm) {
                  return evalIsAtm(ann)(v1);
              };
              if (v instanceof ExprAnn.IsEq) {
                  return evalIsEq(ann)(v1);
              };
              if (v instanceof ExprAnn.Lambda) {
                  return evalLambda(ann)(v1);
              };
              if (v instanceof ExprAnn.Quote) {
                  return evalQuote(ann)(v1);
              };
              if (v instanceof ExprAnn.Rest) {
                  return evalRest(ann)(v1);
              };
              throw new Error("Failed pattern match at Eval (line 213, column 1 - line 213, column 48): " + [ ann.constructor.name, v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var evalRest = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  if (v1.value0 instanceof ExprAnn.Lst && v1.value0.value0 instanceof Data_List_Types.Nil) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Lst(Data_List_Types.Nil.value), ann));
                  };
                  if (v1.value0 instanceof ExprAnn.Lst && v1.value0.value0 instanceof Data_List_Types.Cons) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Lst(v1.value0.value0.value1), ann));
                  };
                  return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.LstTipe.value)(ExprAnn.toExprTipe(v1));
              });
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.Rest.value)(v);
      };
  };
  var evalLst = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(Data_Traversable.traverse(Data_List_Types.traversableList)(applicativeEvalT(Data_Identity.monadIdentity))($$eval)(v.value1))(function (v2) {
                      if (v1.value0 instanceof ExprAnn.Fn) {
                          return applyLambda(ann)(v1.value0.value1)(v2)(v1.value0.value2);
                      };
                      return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.FnTipe.value)(ExprAnn.toExprTipe(v1));
                  });
              });
          };
          if (v instanceof Data_List_Types.Nil) {
              return throwEmptyFnApplicationErr(Data_Identity.monadIdentity)(ann);
          };
          throw new Error("Failed pattern match at Eval (line 321, column 1 - line 321, column 39): " + [ ann.constructor.name, v.constructor.name ]);
      };
  };
  var evalIsEq = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value1.value0))(function (v2) {
                      var v3 = new Data_Tuple.Tuple(v1.value0, v2.value0);
                      if (v3.value0 instanceof ExprAnn.Sym && v3.value1 instanceof ExprAnn.Sym) {
                          var $136 = v3.value0.value0 === v3.value1.value0;
                          if ($136) {
                              return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Sym("true"), ann));
                          };
                          return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Lst(Data_List_Types.Nil.value), ann));
                      };
                      if (v3.value0 instanceof ExprAnn.Lst && (v3.value0.value0 instanceof Data_List_Types.Nil && (v3.value1 instanceof ExprAnn.Lst && v3.value1.value0 instanceof Data_List_Types.Nil))) {
                          return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Sym("true"), ann));
                      };
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Lst(Data_List_Types.Nil.value), ann));
                  });
          ...
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.IsEq.value)(v);
      };
  };
  var evalIsAtm = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  if (v1.value0 instanceof ExprAnn.Sym) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Sym("true"), ann));
                  };
                  if (v1.value0 instanceof ExprAnn.Lst && v1.value0.value0 instanceof Data_List_Types.Nil) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Sym("true"), ann));
          ...
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.IsAtm.value)(v);
      };
  };
  var evalIf = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value1 instanceof Data_List_Types.Cons && v.value1.value1.value1 instanceof Data_List_Types.Nil))) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  ...
                  return $$eval(v.value1.value0);
              });
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.If.value)(v);
      };
  };
  var evalFirst = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  if (v1.value0 instanceof ExprAnn.Lst && v1.value0.value0 instanceof Data_List_Types.Nil) {
                      return throwLstLengthErr(Data_Identity.monadIdentity)(ann)(1)(0);
                  };
                  if (v1.value0 instanceof ExprAnn.Lst && v1.value0.value0 instanceof Data_List_Types.Cons) {
                      return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(v1.value0.value0.value0);
                  };
                  return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.LstTipe.value)(ExprAnn.toExprTipe(v1));
              });
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.First.value)(v);
      };
  };
  var evalDef = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value1.value0))(function (v1) {
                  if (v.value0.value0 instanceof ExprAnn.Sym) {
                      return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(updateEnv(Data_Identity.monadIdentity)(v.value0.value0.value0)(v1))(function (v2) {
                          return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(v1);
                      });
                  };
                  return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.SymTipe.value)(ExprAnn.toExprTipe(v.value0));
              });
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.Def.value)(v);
      };
  };
  var evalCons = function (ann) {
      return function (v) {
          if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
              return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value0))(function (v1) {
                  return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))($$eval(v.value1.value0))(function (v2) {
                      if (v2.value0 instanceof ExprAnn.Lst) {
                          return Control_Applicative.pure(applicativeEvalT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(new ExprAnn.Lst(new Data_List_Types.Cons(v1, v2.value0.value0)), ann));
                      };
                      return throwWrongTipeErr(Data_Identity.monadIdentity)(ann)(ExprAnn.LstTipe.value)(ExprAnn.toExprTipe(v2));
                  });
              });
          };
          return throwSFrmNumArgsErr(Data_Identity.monadIdentity)(ann)(ExprAnn.Cons.value)(v);
      };
  };
  var $$eval = function (v) {
      if (v.value0 instanceof ExprAnn.Sym) {
          return evalSym(v.value1)(v.value0.value0);
      };
      if (v.value0 instanceof ExprAnn.Lst && (v.value0.value0 instanceof Data_List_Types.Cons && v.value0.value0.value0.value0 instanceof ExprAnn.SFrm)) {
          return evalSFrm(v.value1)(v.value0.value0.value0.value0.value0)(v.value0.value0.value1);
      };
      if (v.value0 instanceof ExprAnn.Lst) {
          return evalLst(v.value1)(v.value0.value0);
      };
      return throwUnknownErr(Data_Identity.monadIdentity)(v.value1);
  };
  var applyLambda = function (ann) {
      return function (params) {
          return function (args) {
              return function (body) {
                  return Control_Bind.bind(bindEvalT(Data_Identity.monadIdentity))(bindArgs(ann)(params)(args))(function (v) {
                      var evalState = {
                          env: v
                      };
                      return EvalT(Control_Monad_Except_Trans.mapExceptT(Control_Monad_State_Trans.withStateT(Data_Function["const"](evalState)))(Data_Newtype.unwrap(newtypeEvalT)($$eval(body))));
                  });
              };
          };
      };
  };
  var evalMany = (function () {
      var $229 = Data_Traversable.sequence(Data_List_Types.traversableList)(applicativeEvalT(Data_Identity.monadIdentity));
      var $230 = Data_Functor.map(Data_List_Types.functorList)($$eval);
      return function ($231) {
          return $229($230($231));
      };
  })();
  var runMany = function (env) {
      return function (exprs) {
          return run(env)(evalMany(exprs));
      };
  };
  var evalOne = $$eval;
  var runOne = function (env) {
      return function (expr) {
          return run(env)(evalOne(expr));
      };
  };
  exports["NumArgs"] = NumArgs;
  exports["WrongTipe"] = WrongTipe;
  exports["LstLength"] = LstLength;
  exports["UnknownVar"] = UnknownVar;
  exports["EmptyFnApplication"] = EmptyFnApplication;
  exports["UnknownErr"] = UnknownErr;
  exports["EvalErr"] = EvalErr;
  exports["runMany"] = runMany;
  exports["runOne"] = runOne;
  exports["functorEvalT"] = functorEvalT;
  exports["applicativeEvalT"] = applicativeEvalT;
  exports["bindEvalT"] = bindEvalT;
  exports["monadThrowParserT"] = monadThrowParserT;
  exports["showEvalErr"] = showEvalErr;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
...
(function($PS) {
  ...
  var Text_Parsing_Parser_Token = $PS["Text.Parsing.Parser.Token"];                
  var oneOf = (function () {
      var $17 = Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity);
      return function ($18) {
          return $17(Data_String_CodeUnits.toCharArray($18));
      };
  })();
  var identStart = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Token.letter(Data_Identity.monadIdentity))(oneOf("!$%&*/:<=>?~_^"));
  var identLetter = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(identStart)(Text_Parsing_Parser_Token.digit(Data_Identity.monadIdentity)))(oneOf(".+-"));
  ...
  var lexer = Text_Parsing_Parser_Token.makeTokenParser(Data_Identity.monadIdentity)(langDef);
  var manyOf = Data_Function.flip(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity))(lexer.whiteSpace);
  var fileOf = Text_Parsing_Parser_Combinators.between(Data_Identity.monadIdentity)(lexer.whiteSpace)(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity));
  var annotate = function (p) {
      var unwrapPos = function (v) {
          return v;
      };
      var location = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.position(Data_Identity.monadIdentity))((function () {
          var $19 = Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity));
          return function ($20) {
              return $19(unwrapPos($20));
          };
      })());
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(location)(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(p)(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(location)(function (v2) {
                  var srcSpan = {
                      begin: v,
                      end: v2
                  };
                  ...
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.ExprAnn(v1, ann));
              });
          });
      });
  };
  var listOf = function (p) {
      return annotate(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(ExprAnn.Lst.create)(lexer.parens(Data_List.manyRec(Text_Parsing_Parser.monadRecParserT(Control_Monad_Rec_Class.monadRecIdentity))(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(p))));
  };
  var quoted = function (p) {
      return annotate(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("'"))(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(annotate(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.Quote.value))))(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(p)(function (v2) {
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.Lst(new Data_List_Types.Cons(v1, Control_Applicative.pure(Data_List_Types.applicativeList)(v2))));
              });
          });
      }));
  };
  var symbol = annotate(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.identifier)(function (v) {
      if (v === "::") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.Cons.value));
      };
      if (v === "=") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.Def.value));
      };
      if (v === "==") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.IsEq.value));
      };
      if (v === "atom?") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.IsAtm.value));
      };
      if (v === "first") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.First.value));
      };
      if (v === "fn") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.Lambda.value));
      };
      if (v === "if") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.If.value));
      };
      if (v === "quote") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.Quote.value));
      };
      if (v === "rest") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.SFrm(ExprAnn.Rest.value));
      };
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new ExprAnn.Sym(v));
  }));
  var exprAnn = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(symbol)(quoted(p)))(listOf(p));
  });
  var parseMany = Data_Function.flip(Text_Parsing_Parser.runParser)(fileOf(manyOf(exprAnn)));
  var parseOne = Data_Function.flip(Text_Parsing_Parser.runParser)(fileOf(exprAnn));
...
(function($PS) {
  ...
  var ParseErr = (function () {
      function ParseErr(value0) {
          this.value0 = value0;
      };
      ParseErr.create = function (value0) {
          return new ParseErr(value0);
      };
      return ParseErr;
  })();
  var EvalErr = (function () {
      function EvalErr(value0) {
          this.value0 = value0;
      };
      EvalErr.create = function (value0) {
          return new EvalErr(value0);
      };
      return EvalErr;
  })();
  var showRunErr = new Data_Show.Show(function (v) {
      if (v instanceof ParseErr) {
          return Data_Show.show(Text_Parsing_Parser.showParseError)(v.value0);
      };
      if (v instanceof EvalErr) {
          return Data_Show.show(Eval.showEvalErr)(v.value0);
      };
      throw new Error("Failed pattern match at Main (line 24, column 1 - line 26, column 40): " + [ v.constructor.name ]);
  });
  var runInSharedEnv = function (run$prime) {
      return function (env) {
          var worker = function (accum) {
              return function (program) {
                  var ran = run$prime(accum.env)(program);
                  return {
                      env: ran.env,
                      results: Data_Array.cons(ran.result)(accum.results)
                  };
              };
          };
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(worker)({
              env: env,
              results: Data_Monoid.mempty(Data_Monoid.monoidArray)
          });
      };
  };
  var run = function (dictComonad) {
      return function (parse) {
          return function ($$eval) {
              return function (initEnv) {
                  var failWithParseErr = function (parseErr) {
                      return {
                          env: initEnv,
                          result: Data_Either.Left.create(new ParseErr(parseErr))
                      };
                  };
                  var evalWithEnv = function (expr) {
                      var evaled = Control_Comonad.extract(dictComonad)($$eval(initEnv)(expr));
                      return {
                          env: evaled.env,
                          result: Data_Bifunctor.lmap(Data_Either.bifunctorEither)(EvalErr.create)(evaled.result)
                      };
                  };
                  var $6 = Data_Either.either(failWithParseErr)(evalWithEnv);
                  return function ($7) {
                      return $6(parse($7));
                  };
              };
  ...
  var runMany = run(Data_Identity.comonadIdentity)(Parser.parseMany)(Eval.runMany);
  var runOne = run(Data_Identity.comonadIdentity)(Parser.parseOne)(Eval.runOne);
  var runFromJs = (function () {
      var showResults = (function () {
          var $8 = Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Data_Either.functorEither)(Data_Show.show(ExprAnn.showExprAnn)));
          return function ($9) {
              return Data_Array.reverse($8((function (v) {
                  return v.results;
              })($9)));
          };
      })();
      var run$prime = runInSharedEnv(runOne)(Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString)));
      return function ($10) {
          return showResults(run$prime($10));
      };
  })();
  ...
  exports["runMany"] = runMany;
  exports["run"] = run;
  exports["runInSharedEnv"] = runInSharedEnv;
  exports["runFromJs"] = runFromJs;
  exports["showRunErr"] = showRunErr;
})(PS);
PS["Main"].main();